...
| [math/prefer-number-min-value](https://ota-meshi.github.io/eslint-plugin-math/rules/prefer-number-min-value.html) | enforce the use of Number.MIN_VALUE instead of literal number | 🔧 | ⭐ |
